...
const About = () => {
    return (
        <div className="w-full h-auto bg-[#EFF1F3] flex justify-between px-[10%] ">
            <div className='mt-9'>
                ...
                <p className='  text-[1rem] text-[#000000aa] mr-[10rem]'>As a leading real estate developer in Davao City, Demo Property Development Corporation is committed to crafting exceptional living spaces that redefine urban lifestyles. With a focus on innovation, sustainability, and community-centric design, we transform dreams into reality, one project at a time.</p>
                <button className='my-8 p-5 bg-[#483C32] text-[#ffff] font-light rounded-sm'>Building a Better Future, One Property at a Time</button>
            </div>

            <div className='w-[50rem] h-[25rem] mt-9 rounded-md'
            style={{
            ...
            >
                <div className='flex justify-center items-center flex-col text-white h-full w-full'>
                    ...
                    <button className='py-3 px-5 bg-[#cd9020] text-[#000] rounded-sm font-semibold'>GET NOW</button>
                </div>
            </div>
