...
const Hero = () => {
  return (
    <div
      className="w-full min-h-screen bg-cover bg-center bg-no-repeat flex items-center justify-between flex-col px-[10%]"
      style={{
    ...
    >
        <div className="text-white text-center mt-64 ">
        ...
        <div className="w-full h-[10rem] flex justify-center items-center flex-col">
